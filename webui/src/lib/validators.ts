...
export const ERROR_CODE_FRIENDLY: Partial<Record<ErrCode, string>> = {
  ...
  AUTH_CSRF_MISSING: "登录态已过期，请刷新页面后重试",
  AUTH_CSRF_MISMATCH: "安全令牌不匹配，请刷新页面后重试",
  ...
  AUTH_CSRF_REFRESH_FAILED: "刷新安全令牌失败，请刷新页面后重试",
  ...
  LIBRARY_SELF_SERVICE_DISABLED: "媒体库自助管理未开启",
  LIBRARY_SELF_SERVICE_ACTION_INVALID: "媒体库自助操作不被允许",
  LIBRARY_NOT_SELF_SERVICE: "该媒体库未启用自助管理",
