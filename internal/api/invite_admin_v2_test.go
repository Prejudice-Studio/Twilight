...
func TestV2AdminInviteResourcesUseBoundedShapes(t *testing.T) {
	...
	admin := registerAndLogin(t, app, "v2-invite-admin", "Admin123456")
...
func TestV2AdminInviteConfigExposesOnlyInviteFields(t *testing.T) {
	app := newTestApp(t)
	admin := registerAndLogin(t, app, "v2-invite-config-admin", "Admin123456")
...
func TestV2AdminInviteTreeAppliesCollapsedSearchAndSelectedProjection(t *testing.T) {
	app := newTestApp(t)
	admin := registerAndLogin(t, app, "v2-invite-tree-admin", "Admin123456")
