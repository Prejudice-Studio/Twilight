...
// handleV2AdminCancelPermanent 走独立 handler：/cancel-permanent 的语义是「不再
// 永久」，必须忽略请求体里的 permanent / 负 days，否则路由名与行为相反。
func (a *App) handleV2AdminCancelPermanent(w http.ResponseWriter, r *http.Request, p Params) {
	a.handleAdminCancelPermanent(w, r, p)
}
