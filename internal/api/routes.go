...
func (a *App) registerBatchRoutes() {
	...
	a.add(http.MethodPost, "/api/v1/batch/users/library-self-service", AuthAdmin, a.handleBatchLibrarySelfService)
	a.add(http.MethodPost, "/api/v1/batch/users/libraries", AuthAdmin, a.handleBatchUserLibraries)
