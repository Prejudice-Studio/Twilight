...
func (a *App) registerRoutes() {
	...
	a.add(http.MethodGet, "/api/v1/bangumi/collections", AuthUser, a.handleBangumiCollections)
	a.add(http.MethodPatch, "/api/v1/bangumi/collections/:subject_id", AuthUser, a.handleUpdateBangumiCollection)
	...
	a.add(http.MethodGet, "/api/v1/system/health/api", AuthAdmin, a.handleHealthAPI)
	a.add(http.MethodGet, "/api/v1/system/health/database", AuthAdmin, a.handleHealthDatabase)
	a.add(http.MethodGet, "/api/v1/system/health/emby", AuthAdmin, a.handleHealthEmby)
	...
	a.add(http.MethodGet, "/api/v1/system/emby-viewers", AuthUser, a.handleEmbyViewerCount)
...
func (a *App) registerAdminRoutes() {
	...
	a.add(http.MethodPost, "/api/v1/admin/emby/test", AuthAdmin, a.handleEmbyConnectivityTest)
...
func (a *App) registerStatsInviteSigninAnnouncementRoutes() {
	...
	a.add(http.MethodPost, "/api/v1/invite/me/detach-expired", AuthUser, a.handleDetachMyExpiredInvite)
