...
const (
	...
	ErrMediaRequestSourceInvalid   ErrCode = "MEDIA_REQUEST_SOURCE_INVALID"
	ErrMediaRequestRevisionInvalid ErrCode = "MEDIA_REQUEST_REVISION_INVALID"
	ErrMediaRequestConflict        ErrCode = "MEDIA_REQUEST_CONFLICT"
