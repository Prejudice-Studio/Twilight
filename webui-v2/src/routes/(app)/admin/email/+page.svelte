...
<section class="email-page" aria-labelledby="email-title">
  <PageHeader id="email-title" eyebrow={t.adminArea} title={t.adminEmailTitle} description={t.adminEmailDescription}>
    {#snippet actions()}
  ...
  <section class="maintenance-grid">
    <Panel id="maintenance-title" className="maintenance-panel">
    ...
    <Panel id="clear-title" className="maintenance-panel">
    ...
    <Panel id="test-title" className="maintenance-panel">
...
<style>
  ...
  .panel-heading, .record-header, .identity, .metadata, .pagination { align-items: flex-start; display: flex; gap: .75rem; }
  .panel-heading, .record-header, .pagination { justify-content: space-between; }
  h2, p { overflow-wrap: anywhere; } h2 { margin: 0; font-size: 1.15rem; } .muted { color: #52606d; margin: .35rem 0 0; }
  ...
  @media (max-width: 600px) { .panel-heading, .record-header, .record-row, .account-row { align-items: stretch; flex-direction: column; } .record-row .row-action, .record-row .row-action .button, .maintenance-grid form, .maintenance-grid form .button { width: 100%; } .filter-form { grid-template-columns: 1fr; } .metadata { display: grid; grid-template-columns: 1fr; } .metadata div { min-width: 0; } time { max-width: none; text-align: left; } .record-list, .account-list { max-height: none; overflow: visible; } .pagination { align-items: stretch; } .pagination .button { min-width: 0; } }
</style>
