...
| [许可证与二次开发](./reference/license.md) | AGPL 商业使用、修改版开源、网络部署源码提供与署名保留要求 |
...
| [签到与积分续期](./features/signin.md) | 每日签到、积分余额、手动续期与两级开关自动续期 |
...
| [邀请历史脏数据修复](./features/invite-data-repair.md) | 防止断开上下级后被旧关系或旧邀请码占用记录恢复 |
| [求片系统](./features/media-requests.md) | 状态流转、活跃队列、管理员审核与外部回调语义 |
| [工单系统](./features/tickets.md) | 双方回复、状态流转、并发限额与类型管理 |
...
- V2 重构文档：[V1 审计基线](./v2/v1-audit.md)、[V2 架构设计](./v2/architecture.md)、[V2 SSR 前端](./v2/frontend-ssr.md)、[前端路由矩阵](./v2/frontend-route-matrix.md)、[V2 安全审计报告](./v2/security-audit-report.md)
